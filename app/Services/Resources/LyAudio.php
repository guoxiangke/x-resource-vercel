...
final class LyAudio{
    ...
    if($keyword>600 && $keyword<700){
        $map = array_flip([601 => "",602 => 'fa',603 => "cc",604 => "tv",605 => "gg",606 => "up",607 => 'bx',608 => 'pp',609 => 'ym',610 => "pm",611 => "sa",612 => "bc",613 => "ir",614 => "rt",615 => 'fd',616 => "ws",617 => 'hr',618 => "dy",619 => "ee",620 => "mw",621 => "be",622 => "bs",623 => "cw",624 => "dr",625 => "th",626 => "wr",627 => "yy",628 => "aw",629 => "yp",630 => "mg",
            631 => 'cfbwh',
            632 => "cedna",
            633 => 'cfcbp',
            634 => "cfbls",
